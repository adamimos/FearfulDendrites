...
extern void _glutamate1b_reg(void);
extern void _glutamate1_reg(void);
extern void _glutamate2_reg(void);
...
void modl_reg(){
  if (!nrn_nobanner_) if (nrnmpi_myid < 1) {
    ...
    fprintf(stderr," \"glutamate1b.mod\"");
    fprintf(stderr," \"glutamate1.mod\"");
    fprintf(stderr," \"glutamate2.mod\"");
