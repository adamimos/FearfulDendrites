...
#define nrn_init _nrn_init__glutamate1
#define _nrn_initial _nrn_initial__glutamate1
#define nrn_cur _nrn_cur__glutamate1
#define _nrn_current _nrn_current__glutamate1
#define nrn_jacob _nrn_jacob__glutamate1
#define nrn_state _nrn_state__glutamate1
#define _net_receive _net_receive__glutamate1 
#define state state__glutamate1 
...
#define cah cah_glutamate1
 double cah = 10;
#define gama gama_glutamate1
 double gama = 0.08;
#define n n_glutamate1
 double n = 0.25;
#define tauh tauh_glutamate1
 double tauh = 1000;
...
#define tau1 tau1_glutamate1
 ...
 "cah_glutamate1", &cah_glutamate1,
 "tauh_glutamate1", &tauh_glutamate1,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 glutamate1 /home/adamimos/Documents/Projects/Godenzini/Archive/glutamate1.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
 ...
 {int  _lcount ;for ( _lcount = 0 ; _lcount <= ((int) Nspike ) - 1 ; _lcount ++ ) {
     if ( at_time ( nrn_threads, ((double) _lcount ) * Tspike + del2 ) ) {
 ...
 v=_v;
{
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 80 in file glutamate1.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/adamimos/Documents/Projects/Godenzini/Archive/glutamate1.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "//****************************//\n"
