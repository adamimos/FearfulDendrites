...
#PARAMETERS
nBackgroundSyns = 75
batch_name = "background_runs"+str(np.random.randint(0,40000))+".p"

print('running just background sim')
...
output = {'time':t_data, 'soma_v':v_data, 'apic_v':d_v_data, 'basal_v':b_v_data,
         'num_spikes':len(find_peaks(v,height=0)[0]), 'nBackgroundSyns': nBackgroundSyns}
