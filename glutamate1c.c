...
#define nrn_init _nrn_init__glutamate1c
#define _nrn_initial _nrn_initial__glutamate1c
#define nrn_cur _nrn_cur__glutamate1c
#define _nrn_current _nrn_current__glutamate1c
#define nrn_jacob _nrn_jacob__glutamate1c
#define nrn_state _nrn_state__glutamate1c
#define _net_receive _net_receive__glutamate1c 
#define state state__glutamate1c 
...
#define cah cah_glutamate1c
 double cah = 10;
#define gama gama_glutamate1c
 double gama = 0.08;
#define n n_glutamate1c
 double n = 0.25;
#define tauh tauh_glutamate1c
 double tauh = 1000;
#define tau_ampa tau_ampa_glutamate1c
 double tau_ampa = 2;
#define tau2 tau2_glutamate1c
 double tau2 = 5;
#define tau1 tau1_glutamate1c
 double tau1 = 90;
 ...
 "tau1_glutamate1c", &tau1_glutamate1c,
 "tau2_glutamate1c", &tau2_glutamate1c,
 "tau_ampa_glutamate1c", &tau_ampa_glutamate1c,
 "n_glutamate1c", &n_glutamate1c,
 "gama_glutamate1c", &gama_glutamate1c,
 "cah_glutamate1c", &cah_glutamate1c,
 "tauh_glutamate1c", &tauh_glutamate1c,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 glutamate1c C:/Users/Amy/Documents/Godenzini/Archive/glutamate1c.mod\n");
 ...
 v=_v;
{
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 79 in file glutamate1c.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "glutamate1c.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "//****************************//\n"
